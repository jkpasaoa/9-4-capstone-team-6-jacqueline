    ...
    <div className='mb-[-65px] navBar'>
      <nav
        ...
        <div className="flex flex-wrap items-center justify-between mx-auto p-2 text-sky-950 ml-16 mr-16">
          <span className="logo ">
            <a href="/" className="w-[220px] flex flex-col items-center"> {/* Use flex-col to stack items vertically */}
              <img
                src={logo}
                className="mt-1.5 mr-3 w-[110%] h-[110%] drop-shadow-[2px_0px_5px_rgba(255,255,255,0.5)]"
